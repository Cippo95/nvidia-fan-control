...
So I've looked how this NVIDIA API works and I have written `nv-control-fan.c` that compiles in `nv-control-fan`, it sets **all the fans of the graphics card to the same speed**.
